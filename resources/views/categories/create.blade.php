...
@section('title', 'Tambah Kategori - Finance Tracker')
        ...
        <form action="{{ route('categories.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="name" 
                       ...
                       placeholder="Contoh: Makanan, Transport, dll" required value="{{ old('name') }}">
                @error('name')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-8 gap-2" id="iconGrid">
                    ...
                    <label class="cursor-pointer">
                        <input type="radio" name="icon" value="{{ $emoji }}" class="peer hidden" required>
            ...
            <div class="mb-6 p-4 bg-gray-50 rounded-lg">
                ...
                <div class="flex items-center gap-3 p-4 bg-white rounded-lg border" id="preview">
                    <div class="w-12 h-12 rounded-full flex items-center justify-center text-2xl" id="previewIcon" style="background-color: #e5e7eb">
                        💰
                    </div>
                    <span class="font-semibold" id="previewName">Nama Kategori</span>
                </div>
            </div>
